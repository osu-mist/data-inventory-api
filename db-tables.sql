...
(
    ...
    UPDATED_AT             DATE,
    DELETED_AT             DATE,
    CONSTRAINT PK_INVENTORY_CONSUMING_ENTITIES PRIMARY KEY
        (
            ENTITY_ID
        )    
    USING INDEX TABLESPACE INDX)
...
CREATE SEQUENCE apismgr.INVENTORY_CONSUMING_ENTITIES_SEQ
  MINVALUE 1
  START WITH 1
  INCREMENT BY 1
  NOCACHE;

CREATE PUBLIC SYNONYM INVENTORY_CONSUMING_ENTITIES_SEQ FOR apismgr.INVENTORY_CONSUMING_ENTITIES_SEQ;
